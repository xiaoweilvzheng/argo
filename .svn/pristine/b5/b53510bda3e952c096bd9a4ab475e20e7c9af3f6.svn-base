package com.jx.argo.convention;
...
public @interface GroupConventionAnnotation {
    ...
    /**
     * 约定组织中所有项目必须实现的类,
     * @see com.jx.argo.convention.GroupConvention.ProjectConfig
     *
     * 该类实现项目的Id用于项目的唯一编号，并便于管理
     * @see com.jx.argo.convention.GroupConvention.ProjectConfig#id()
     *
     * 同时实现module，
     ...
     * @return group包的前缀
     */
    String groupPackagesPrefix() default "com.jx";
