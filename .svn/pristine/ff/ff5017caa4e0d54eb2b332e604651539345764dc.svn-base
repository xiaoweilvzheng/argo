...
import com.jx.argo.annotations.GET;
import com.jx.argo.annotations.POST;
...
import com.jx.argo.thirdparty.AnnotationUtils;
import com.jx.argo.thirdparty.AntPathMatcher;
import com.jx.argo.thirdparty.PathMatcher;
import com.jx.argo.utils.ClassUtils;
import com.jx.argo.utils.Pair;
import com.jx.argo.utils.converter.ConverterFactory;
...
public class ActionInfo {
    ...
    String simplyPathPattern(ControllerInfo controllerInfo, Path path) {
        ...
        System.out.println("========"+originPathPattern);
