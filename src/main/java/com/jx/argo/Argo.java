...
import com.jx.argo.inject.ArgoModule;
...
public static void main(String[] args){
	...
	System.out.println(new Argo().innerCurrentFolder());
}
public  String getwebappapth(){
