...
import com.jx.argo.client.ClientContext.DefaultClientContext;
import com.jx.argo.convention.GroupConvention;
import com.jx.argo.internal.DefaultBeatContext;
import com.jx.argo.internal.DefaultModel;
import com.jx.argo.internal.DefaultMultipartConfigElementProvider;
import com.jx.argo.internal.StaticFilesAction;
import com.jx.argo.internal.actionresult.StatusCodeActionResult;
import com.jx.argo.route.Action;
import com.jx.argo.route.StaticActionAnnotation;
 ...
 * 优先级有低到高的顺序是
 * Argo
 * @see com.jx.argo.convention.ProjectConvention
 * @see com.jx.argo.convention.GroupConvention.ProjectConfig#module()
 *
 * @author renjun
 */
