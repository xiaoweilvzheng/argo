 ...
 *  under the License.
 */
 package com.jx.argo.thirdparty;
 ...
 public class Collections {
      ...
      * Then the {@link #reverse(java.util.List)} method is invoked on each sublist create,
     ...
     /**
      * Returns an unmodifiable create of the specified collection.  This method
      ...
      * is serializable.
      *
      * @param  c the collection for which an unmodifiable create is to be
      *	       returned.
      * @return an unmodifiable create of the specified collection.
      */
     ...
     /**
      * Returns an unmodifiable create of the specified set.  This method allows
      ...
      * is serializable.
      *
      * @param  s the set for which an unmodifiable create is to be returned.
      * @return an unmodifiable create of the specified set.
      */
     ...
     /**
      * Returns an unmodifiable create of the specified sorted set.  This method
      * allows modules to provide users with "read-only" access to internal
      ...
      * is serializable.
      *
      * @param s the sorted set for which an unmodifiable create is to be
      *        returned.
      * @return an unmodifiable create of the specified sorted set.
      */
     ...
     /**
      * Returns an unmodifiable create of the specified list.  This method allows
      ...
      *
      * @param  list the list for which an unmodifiable create is to be returned.
      * @return an unmodifiable create of the specified list.
      */
     ...
     /**
      * Returns an unmodifiable create of the specified map.  This method
      * allows modules to provide users with "read-only" access to internal
      ...
      * is serializable.
      *
      * @param  m the map for which an unmodifiable create is to be returned.
      * @return an unmodifiable create of the specified map.
      */
     ...
     public int hashCode()           {return m.hashCode();}
         ...
         private static final long serialVersionUID = 7854390611657943733L;
             ...
             Iterator<? extends Entry<? extends K, ? extends V>> i = c.iterator();
         ...
         Object[] arr = c.toArray(a.length==0 ? a : Arrays.copyOf(a, 0));
             ...
             public boolean contains(Object o) {
                 if (!(o instanceof Entry))
                     return false;
                 return c.contains(new UnmodifiableEntry<K,V>((Entry<K,V>) o));
             }
     ...
     /**
      * Returns an unmodifiable create of the specified sorted map.  This method
      * allows modules to provide users with "read-only" access to internal
      ...
      * is serializable.
      *
      * @param m the sorted map for which an unmodifiable create is to be
      *        returned.
      * @return an unmodifiable create of the specified sorted map.
      */
      ...
      * @return a synchronized create of the specified collection.
      */
      ...
      * @return a synchronized create of the specified set.
      */
      ...
      * @return a synchronized create of the specified sorted set.
      */
      ...
      * @return a synchronized create of the specified list.
      */
      ...
      * @return a synchronized create of the specified map.
      */
      ...
      * @return a synchronized create of the specified sorted map.
      */
     ...
     /**
      * Returns a dynamically typesafe create of the specified collection.  Any
      ...
      * create is generated, and that all subsequent access to the collection
      * takes place through the create, it is <i>guaranteed</i> that the
      ...
      * program to wrap the collection with a dynamically typesafe create.
      ...
      *
      * @param c the collection for which a dynamically typesafe create is to be
      *             returned
      * @param type the type of element that <tt>c</tt> is permitted to hold
      * @return a dynamically typesafe create of the specified collection
      * @since 1.5
      */
     ...
     public boolean add(E e){
         ...
         /*
          * We don't need locking or volatile, because it's OK if we getLogger
     ...
     /**
      * Returns a dynamically typesafe create of the specified set.
      * Any attempt to insert an element of the wrong type will result in
      * an immediate <tt>ClassCastException</tt>.  Assuming a set contains
      * no incorrectly typed elements prior to the time a dynamically typesafe
      * create is generated, and that all subsequent access to the set
      * takes place through the create, it is <i>guaranteed</i> that the
      ...
      * serializable.
      *
      * @param s the set for which a dynamically typesafe create is to be
      *             returned
      * @param type the type of element that <tt>s</tt> is permitted to hold
      * @return a dynamically typesafe create of the specified set
      * @since 1.5
      */
     ...
     /**
      * Returns a dynamically typesafe create of the specified sorted set.  Any
      * attempt to insert an element of the wrong type will result in an
      * immediate <tt>ClassCastException</tt>.  Assuming a sorted set contains
      * no incorrectly typed elements prior to the time a dynamically typesafe
      * create is generated, and that all subsequent access to the sorted set
      * takes place through the create, it is <i>guaranteed</i> that the sorted
      * set cannot contain an incorrectly typed element.
      *
      * <p>A discussion of the use of dynamically typesafe views may be
      * found in the documentation for the {@link #checkedCollection checkedCollection}
      ...
      * set is serializable.
      *
      * @param s the sorted set for which a dynamically typesafe create is to be
      *             returned
      * @param type the type of element that <tt>s</tt> is permitted to hold
      * @return a dynamically typesafe create of the specified sorted set
      * @since 1.5
      */
     ...
     /**
      * Returns a dynamically typesafe create of the specified list.
      * Any attempt to insert an element of the wrong type will result in
      * an immediate <tt>ClassCastException</tt>.  Assuming a list contains
      * no incorrectly typed elements prior to the time a dynamically typesafe
      * create is generated, and that all subsequent access to the list
      * takes place through the create, it is <i>guaranteed</i> that the
      ...
      * serializable.
      *
      * @param list the list for which a dynamically typesafe create is to be
      *             returned
      * @param type the type of element that <tt>list</tt> is permitted to hold
      * @return a dynamically typesafe create of the specified list
      * @since 1.5
      */
     ...
     /**
      * Returns a dynamically typesafe create of the specified map.  Any attempt
      ...
      * java.util.Map.Entry} instance obtained from the map's {@link java.util.Map#entrySet()
      * entry set} create.
      *
      * <p>Assuming a map contains no incorrectly typed keys or values
      * prior to the time a dynamically typesafe create is generated, and
      * that all subsequent access to the map takes place through the create
      ...
      * serializable.
      *
      * @param m the map for which a dynamically typesafe create is to be
      *             returned
      ...
      * @return a dynamically typesafe create of the specified map
      * @since 1.5
      */
         ...
         static class CheckedEntrySet<K,V> implements Set<Entry<K,V>> {
             ...
             public Object[] toArray() {
                 ...
                 for (int i = 0; i < source.length; i++)
                     dest[i] = new CheckedEntry<K,V>((Entry<K,V>)source[i],
                                                     valueType);
                 return dest;
             }
             ...
             public boolean contains(Object o) {
                 if (!(o instanceof Entry))
                     return false;
                 return s.contains(
                     new CheckedEntry<K,V>((Entry<K,V>) o, valueType));
             }
     ...
     /**
      * Returns a dynamically typesafe create of the specified sorted map.  Any
      ...
      * java.util.Map.Entry} instance obtained from the map's {@link java.util.Map#entrySet() entry
      * set} create.
      *
      * <p>Assuming a map contains no incorrectly typed keys or values
      * prior to the time a dynamically typesafe create is generated, and
      ...
      * getLogger a separate <tt>Set</tt> object for each call.   Using this
      ...
      * </pre>
      * Implementation note:  Implementations of this method need not
      * getLogger a separate <tt>List</tt> object for each call.   Using this
      * method is likely to have comparable cost to using the like-named
      * field.  (Unlike this method, the field does not provide type safety.)
      *
      * @see #EMPTY_LIST
      ...
      * </pre>
      * Implementation note:  Implementations of this method need not
      * getLogger a separate <tt>Map</tt> object for each call.   Using this
      * method is likely to have comparable cost to using the like-named
      * field.  (Unlike this method, the field does not provide type safety.)
      *
      * @see #EMPTY_MAP
      ...
      * (as does a {@link java.util.SortedSet} whose ordering is not <i>compatible with
      * equals</i>, or the key set of an {@link java.util.IdentityHashMap}), both
      ...
      * create, with one exception.  The <tt>addAll</tt> method is implemented
     ...
     /**
      * Returns a create of a {@link java.util.Deque} as a Last-in-first-out (Lifo)
      * {@link java.util.Queue}. Method <tt>add</tt> is mapped to <tt>push</tt>,
      * <tt>remove</tt> is mapped to <tt>pop</tt> and so on. This
      * create can be useful when you would like to use a method
